							...
							<?php for ($i = 0; $i < $total_items_carrusel; $i++): ?>
								<div class="item">
									<div class="hero-wrap-item center-item">
										...
										<a href="<?php echo $items_carrusel[$i]['extras_home_carrusel_item_url']; ?>" class="hero-link custom-scroll-link">
											<?php echo $items_carrusel[$i]['extras_home_carrusel_item_boton']; ?>
										</a>
									</div>
								</div>
								<?php endfor; ?>
				...
				<section id="sec1">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-8">
								<!-- section title  -->
								<h2 class="section-title">Bienvenidos somos <strong> GRUPO ARYBA</strong></h2>
								<!-- section title  end -->
