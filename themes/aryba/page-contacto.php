			...
			<section class="parallax-section">
				...
				<div class="container">
					<div class="page-title">
						<div class="row">
							<div class="col-md-6">
								<h2> Nuestro <strong> Contacto </strong></h2>
							</div>
							<div class="col-md-6">
								<ul class="creat-list">
		...
		<div class="content">
			<section>
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<h2 class="section-title">Dónde <strong>Encontrarnos </strong></h2>
							...
							<div class="contact-form-holder">
								<div id="contact-form">
									...
									<form method="post" name="contactform" id="contactform">
										...
										<p>
											<textarea name="comments" id="comments" placeholder="Deja tu mensaje..." required></textarea>
										</p>



										<button type="submit" id="submit" data-top-bottom="transform: translateY(-50px);" data-bottom-top="transform: translateY(50px);"><span>Enviar Mensaje </span></button>
									</form>
								</div>
							</div>
							<!-- contact form  end-->
