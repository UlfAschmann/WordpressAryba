...
<div class="content-holder">
    <!-- Page title -->
    <div class="dynamic-title">Proyecto Individual</div>
    <!-- Page title  end-->
    <!-- content  -->
    <!-- content  -->
    <div class="content">
        <section class="parallax-section">
            <div class="parallax-inner">
                <?php $imagen_banner = get_field('proyectos_imagen_home', $post_id) ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <ul class="creat-list">
                                ...
                                <li><a href="<?php echo get_home_url(); ?>/proyectos">Portfolio</a></li>
    ...
    <div class="content">
        <section>
            <div class="container">
                <?php $galeria = get_field('proyectos_galeria', $post_id); ?>
                <?php if ($galeria): ?>
                    ...
                    <div class="custom-inner">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php $detalles = get_field('proyectos_detalles', $post_id); ?>
                                <?php if ($detalles): ?>
                                    <?php $num_items = count($detalles); ?>
                                    <!-- 1 -->
                                    <?php for ($i = 0; $i < $num_items; $i++): ?>
                                        <h4 class="lista-single"><?php echo $detalles[$i]['proyectos_detalles_titulo'];?></h4>
                                        <p>><?php echo $detalles[$i]['proyectos_detalles_descripcion'];?></p>
                                    <?php endfor; ?>
                                <?php endif; ?>

                                <a href="<?php echo get_home_url(); ?>/proyectos" class=" btn anim-button   flat-btn   transition  fl-l"><span>Regresar</span><i class="fa fa-eye"></i></a>
